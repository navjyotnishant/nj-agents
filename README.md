...
[`docs/architecture/`](docs/architecture/) for the full set (editable `.drawio` +
exported SVG, generated by the suite's own `/arch-diagram`).

![Suite architecture](docs/architecture/system-arch.svg)
