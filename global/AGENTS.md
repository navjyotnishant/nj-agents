...
| `/capture-screenshots` | Capture → a `Workflow`-tool pipeline detects PII/secrets → blurs/masks → **verifies coverage before writing**, run independently per image. | `screenshot-capturer`, `sensitive-data-reviewer`, `screenshot-redactor` |
